...
// Log in for RETURNING users (they already have an account and just want their articles).
//
// Distinct from the account wall: the wall gates the pipeline after an upload and shows
// the "your recording is ready" file pill. This has no pending upload — same auth, no
// file framing. After auth, App sends a returning user straight to their KB.
