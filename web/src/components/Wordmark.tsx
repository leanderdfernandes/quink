// The Quink wordmark (logo-name.svg): "Qu⚡nk" — the "i" is a lightning bolt.
// Letters inherit currentColor so the mark adapts to its context; the bolt keeps its
// green accent (part of the logo, not a themeable UI element).
